...
public class SkystoneDeterminationPipeline extends OpenCvPipeline {
     ...
     */
    static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(75,175);
    static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(270,100);
    static final Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(450,175);
